...
function WorkSpec({ work, ui, locale }: WorkSpecProps) {
  const rows = [
    { key: 'period', label: ui.period, value: work.period },
    { key: 'role', label: ui.role, value: work.role },
    { key: 'scale', label: ui.scale, value: work.scale },
