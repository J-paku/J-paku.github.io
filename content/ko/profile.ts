...
export const profile: Profile = {
  ...
  careers: [
    ...
    },
    {
      ...
      role: '프론트엔드 / 사내 정보기반',
      assignments: [
        { period: '2023.10 - 2024.12', label: '파견처: 시스템 개발 회사' },
        { period: '2022.04 - 2023.09', label: '파견처: 사업회사 정보시스템 부문' },
      ],
      summary:
      ...
      detail: {
        ...
        facts: [
          ...
          {
            label: '파견처',
            value: '시스템 개발 회사(2023.10 - 2024.12)/ 사업회사 정보시스템 부문(2022.04 - 2023.09)',
          },
        ],
        assignments: [
          {
            client: '파견처: 시스템 개발 회사',
