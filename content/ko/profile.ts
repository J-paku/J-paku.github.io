...
export const profile: Profile = {
  ...
  location: '오사카',
  goal: '회사 업무를 지탱하는 UI를 설계부터 운용까지 스스로 맡아왔다. 다음은 설계 판단을 부딪쳐볼 수 있는 팀에서, 회사 밖 사용자에게 닿는 프로덕트를 만들고 싶다.',
  links: {
  ...
  careers: [
    {
      id: 'current',
      // ※회사명은 공개(2026-09-20 결정), 업종은 summary로 옮김
      company: '小山株式会社',
      period: '2025.01 - 현재',
      stack: ['Next.js', 'React', 'TypeScript', 'Swift', '팀 표준 AI 개발 기반'],
      role: '웹개발팀 리더(팀원 4명 + 테스터 1명)',
      summary:
        '의료·간병용품 상사의 사내 업무 시스템 프론트엔드 전 영역을 설계·구현. 입사 9개월 만에 팀 리더. 웹과 iOS를 혼자 횡단하고 있다.',
      highlights: [
      ...
      detail: {
        overview: {
          ...
          meta: '2025.06 착수 · 개발·운용 14개월 · 2025.12 본운용(8개월) · 전사 200명 이상 사용',
        },
        origin: {
        ...
        asides: {
          ...
          items: [
            ...
            },
            {
              ...
              body: '팀원 4명에게 배포하고 정착까지 동행했다. 도입 2개월 만에 팀의 코드 추가 행수는 약 4배(15,811행 → 63,307행)가 됐고, AI 팀 자동 실행 105건 중 87.6%가 사람 손질 없이 완료되고 있다.',
            },
            {
    ...
    {
      id: 'contract-dev',
      // ※재직은 수탁개발 회사 1개사이고, 파견처 2곳의 업무를 이 1항목으로 묶었다. 사명은 공개(2026-09-20 결정), 업종은 summary로 옮김. 파견처 2곳의 사명은 비공개 유지
      // ※입사·퇴사 월은 확인 필요
      company: 'メイテックフィルダーズ',
