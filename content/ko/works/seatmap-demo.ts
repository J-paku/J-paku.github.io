  ...
  detail: {
    sections: [
      ...
      },
      {
        ...
        title: '왜 만들었나',
        paragraphs: [
          '외근 중 전화를 걸려다 손이 멈춘다. 상대가 회의 중일 수도 있다. 확인하려면 PC 표시 그대로 운용되던 Garoon 스케줄 화면을 스마트폰으로 확대해 가며 읽고, 별도의 좌석표와 머릿속에서 맞춰 볼 수밖에 없었다. 신입사원에게는 그 과장이 어느 자리의 누구인지 알아볼 수단 자체가 없었다. 전화번호부 등록은 담당자의 VBA 작업을 기다려야 했다.',
