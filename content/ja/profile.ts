...
export const profile: Profile = {
  ...
  careers: [
    ...
    },
    {
      ...
      role: 'フロントエンド / 社内情報基盤',
      assignments: [
        { period: '2023.10 - 2024.12', label: '派遣先: システム開発会社' },
        { period: '2022.04 - 2023.09', label: '派遣先: 事業会社の情報システム部門' },
      ],
      summary:
      ...
      highlights: [
        ...
        '※前半(2022.04 - 2023.09)はSPA開発を含まない。SPAは後半の派遣先から',
      ],
      detail: {
        overview: {
          title: '派遣先2社での構築・運用',
        ...
        facts: [
          ...
          {
            label: '派遣先',
            value: 'システム開発会社(2023.10 - 2024.12)/ 事業会社の情報システム部門(2022.04 - 2023.09)',
          },
        ],
        assignments: [
          {
