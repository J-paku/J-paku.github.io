...
export const profile: Profile = {
  ...
  careers: [
    {
      id: 'current',
      // ※社名は公開(2026-09-20 決定)、業種は summary に移した
      company: '小山株式会社',
      period: '2025.01 - 現在',
      stack: ['Next.js', 'React', 'TypeScript', 'Swift', 'チーム標準AI開発基盤'],
      role: 'Web開発チームリーダー(メンバー4名 + テスター1名)',
      summary:
        '医療・介護用品商社の社内業務システムのフロントエンド全域を設計・実装。入社9か月でチームリーダー。Web・iOSの両方を1人で横断している。',
      highlights: [
      ...
      detail: {
        overview: {
          ...
          meta: '2025.06着手 · 開発・運用14か月 · 2025.12本運用(8か月) · 全社200名以上が利用',
        },
        origin: {
        ...
        asides: {
          ...
          items: [
            ...
            },
            {
              ...
              body: '個人情報を社外へ出せない前提で、Mac上のGemma 4に申込書を読ませる仕組みを構築中。A4を丸ごと渡さず欄ごとに切り出し、空欄はAIに渡さない。答えは人名辞書・郵便番号データと照らしてok / 要確認 / 空欄 の3つに分け、人は「要確認」だけ見る。確定した答えを学習材料として貯め、追加学習は未学習の申込書で比べてから切り替える運用まで設計済み。',
            },
          ],
        },
      },
    ...
    {
      id: 'contract-dev',
      // ※在籍は受託開発会社1社で、派遣先2社での業務をこの1項目にまとめている。社名は公開(2026-09-20 決定)、業種は summary に移した。派遣先2社の社名は非公開のまま
      // ※入社・退社月は要確認
      company: 'メイテックフィルダーズ',
