...
export const village: VillageText = {
  intro:
    'フロントエンド / プロダクトエンジニアJ-Pakuのポートフォリオ。8か所を歩いて回ると、私がどんな問題を解くのかが分かります。',
  promise: '1分・8か所・代表作3つ',
  ...
  toList: '作品一覧へ',
  toVillage: 'マップで見る',
  allSeen: '8か所すべて見ました。「{list}」から作品をもう一度たどれます。',
  buttonA: '決定',
  buttonB: 'キャンセル',
  joystick: '移動スティック',
  ...
  stops: {
    ...
    campfire: {
      place: '焚き火',
      arrive: '焚き火がぱちぱちと燃えています。少し休んでいきますか?',
      talk: '火にあたる',
      title: '仕組みは、チームで使われてこそ',
      claim: '作った仕組みは、チームで使い続けられて初めて役に立つと考えています。',
      proof:
        'AI開発環境は配って終わりにせず、週1回の活用事例の共有と、隣に座って一緒に依頼を回す支援を続けました。設計規約も文書にして、hookで機械的に守れる形にしています。',
      hook: '次は、ポストへ寄ってみてください。',
      next: 'ポストへ',
      detail:
        '導入と運用まで担当した結果、AIチームが自動で完了した作業のうち87.6%は人の手直しなしで完了しています。',
    },
    mailbox: {
      place: 'ポスト',
      title: '気軽にご連絡ください',
      ...
      hook: 'ありがとうございました。最後に、北の道の先へ歩いてみてください。',
      next: '次の旅へ',
